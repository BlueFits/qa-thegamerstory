        ...
        <Layout>
            ...
            <section style={{ width: "100%", overflowX: "hidden" }} className={"bg-black flex justify-center p-36"}>
                <div style={{ width: 1000 }}>
                    ...
                    <img style={{ width: "100%", margin: "100px 0" }} src="https://media.discordapp.net/attachments/872578374256717854/873749248842285096/Final_Fantasy_XIV_A_Realm_Reborn_Screenshot_2021.08.07_-_22.06.57.15.png?width=1101&height=461"/>
